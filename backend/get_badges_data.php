...
//$badge_data = $badges_manager->getBadgeStats($kukudushi);

//calculate unlocked badges for each badge here
...
$data = [
    'Badges' => [
        [
            'Name' => 'Coin Badge',
            'Unlocked' => 0, //calculate based on coins collected
            'Collected' => 0, //get from $bedge_data
            'BadgeRanks' => $CoinBadgeRanks, //unlock amounts
        ],
        [
            'Name' => 'Fact Badge',
            'Unlocked' => 0, //calculate based on facts collected
            'Collected' => 0, //get from $bedge_data
